...
const { bacsilist } = this.state;
    return (
        ...
        <div className="col-md-3 col-xs-12" style={{background: 'white'}}>
          <div className="white-box m-b-0">
            ...
            <div className="user-bg infousermm"> <img width="100%" alt="user" src={"http://103.57.222.116/public/uploads/customer/"+khachhang.anhdaidien} /> </div>
            <div className="">
              {/* .row */}
    ...
    <p>{moment(khachhang.created_at).format("DD-MM-YYYY HH:mm:ss")}</p>
        ...
        {localStorage.getItem('userrole')==="3" ? <p>Không có quyền xem</p> : <p>{khachhang.dienthoai}</p>}
      </div>
