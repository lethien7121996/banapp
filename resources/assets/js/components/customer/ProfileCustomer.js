...
const { bacsilist } = this.state;
    ...
    <p className="danhturieng">{khachhang.hoten}</p>
            ...
            <div className="row text-center m-t-10">
            {localStorage.getItem('userrole')==="3" ? <p></p> : <button type="button" className="btn btn-block  btn-warning" data-toggle="modal" data-target="#exampleModalPrint" data-whatever="@mdo">IN THÔNG TIN KHÁCH HÀNG</button>}
    ...
    <div className="row text-center m-t-30">
        ...
        {tiensubenhsingle.map(dv => (
           <li key={dv.id} className="list-group-item">{dv.ten}</li>
              ...
              <div className="row text-center m-t-10">
                <div className="col-md-6 b-r"><strong>Ngày tạo hồ sơ</strong>
    <p>{moment(khachhang.created_at).format("DD-MM-YYYY HH:mm:ss")}</p>
                </div>
                <div className="col-md-6"><strong>Mã khách hàng</strong>
                  <p>{"ST-"+khachhang.ID}</p>
                </div>
                <hr />
    ...
    <p>{tiendoanhthukhach.doanhthukhachhang} VNĐ</p>
              ...
              <div className="row text-center m-t-10">
              {localStorage.getItem('userrole')==="3" ? <p></p> : <button type="button" className="btn btn-block  btn-success" data-toggle="modal" data-target="#exampleModal2" onClick={this.updatekhachhang} data-whatever="@mdo">CHỈNH SỬA THÔNG TIN KHÁCH HÀNG</button>}
                      ...
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          onChange={this.handleFieldChange} className="form-control">
                            ...
                            <option className="itemkhuvuc" value="Quận Bình Thạnh (Hồ Chí Minh)">Quận Bình Thạnh (Hồ Chí Minh)</option>
                            <option className="itemkhuvuc" value="Quận Tân Bình (Hồ Chí Minh)">Quận Tân Bình (Hồ Chí Minh)</option>
                            <option className="itemkhuvuc" value="Quận Tân Phú (Hồ Chí Minh)">Quận Tân Phú (Hồ Chí Minh)</option>
 ...
 <label htmlFor={'flat-checkbox-'+ts.id}>{ts.ten}</label>
    ...
    <div className="modal-dialog" role="document">
      <div className="modal-content">
      <BangInThongTin key={khachhang.ID} benhly={benhly} datakhachhang={khachhang} dichvudieutri={dichvudieutrisingle} tiensubenh={tiensubenhsingle} nguongioithieu={nguongioithieusingle.nguon} />
