...
const { bacsilist } = this.state;
            ...
            <div className="white-box">
              <div className="r-icon-stats"> <i className="ti-user bg-megna" />
                <div className="bodystate">
                  <h4>{tongkhachhang.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")}</h4> <span className="text-muted">Tổng khách hàng</span> </div>
              </div>
            </div>
          </div>
          <div className="col-md-3 col-sm-6">
            <div className="white-box">
              <div className="r-icon-stats"> <i className="ti-shopping-cart bg-info" />
                <div className="bodystate">
                  <h4>{tongdoanhthu.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")+" VNĐ"}</h4> <span className="text-muted">Tổng doanh thu</span> </div>
              </div>
            </div>
          </div>
          <div className="col-md-3 col-sm-6">
            <div className="white-box">
              <div className="r-icon-stats"> <i className="ti-wallet bg-success" />
                <div className="bodystate">
                  <h4>{tongno.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")+" VNĐ"}</h4> <span className="text-muted">Tiền khách hàng nợ</span> </div>
              </div>
            </div>
          </div>
          <div className="col-md-3 col-sm-6">
            <div className="white-box">
              <div className="r-icon-stats"> <i className="ti-wallet bg-inverse" />
                <div className="bodystate">
                  <h4>{tongthucnhan.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ".")+" VNĐ"}</h4> <span className="text-muted">Doanh thu thực</span> </div>
              </div>
            </div>
          </div>
        </div>
  ...
  <div className="col-lg-6">
              ...
              <input type="text" className="form-control mydatepicker"  name="ngaythanhtoan" autoComplete="off" placeholder="dd/mm/yyyy" onChange={this.handleFieldChange} />
              <span className="input-group-addon iccale"><i className="icon-calender" /></span>
           
              </div>
              <div className="input-group hidden" id="khoanngaydatao">
              <input className="form-control input-daterange-datepicker" type="text" autoComplete="off" name="khoangngaythanhtoan" value=""  placeholder="dd/mm/yyyy - dd/mm/yyyy" onChange={this.handleFieldChange} />
              <span className="input-group-addon iccale"><i className="icon-calender" /></span>
        ...
        <div className="row">
                    <div className="col-lg-12">
                        <div className="white-box">
                            <h3 className="box-title m-b-0">Danh sách khách hàng thanh toán<button className="btn btn-primary" onClick={this.handleReset}><i className="fa fa-refresh"></i></button></h3>
